...
<div class="modal fade bs-example-modal-lg modal-reg-prov" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			<form action="paginas/inventario/fcn/f_categorias.php" data-method="updateCategoria" id="update-categoria-form" class="form-proveedor reg-prov-form" method="post"  >			
