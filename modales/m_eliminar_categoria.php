	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body marL20 marR20 ">		
				<br>	
				<p class="t16 text-center">&iquest;Estas seguro de eliminar la categoria?</p>
			</div>				
				
				
			<div class="modal-footer">
				<hr>
				<button type="button" class="btn btn-default btn-usr-act btn-usr-act marT15 marB5" data-dismiss="modal"
				aria-label="Close">
					Cancelar
				</button>
