<div class="modal fade bs-example-modal-lg modal-conf" data-type="correo"  tabindex="-1" role="dialog"
	aria-labelledby="myLargeModalLabel" id="descuento">
			...
			<div class="modal-header">
				...
				<h3 class="modal-title ">
					<img src="galeria/img-site/logos/mascota.png" width="50" height="51"><span
						id="" class="marL15">Agregar Descuento</span>
				</h3>
			</div>
			<form id="frm-reg-desc" action="" method="post"
				class="form-inline">
						...
						<div class="row">
							...
							<div
								...
								<input type="text" class="form-input "
									id="p_descuento" name="p_descuento"
									placeholder=" Ingresa el descuento a esta venta"
