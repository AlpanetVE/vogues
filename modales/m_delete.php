...
aria-labelledby="myLargeModalLabel" id="msj-eliminar">
	<div class="modal-dialog">
		<div class="modal-content">
			<form id="usr-act-form-delete" action="fcn/f_usuarios.php" method="post" class="form-inline" data-method="updateStatus" >
			...
			<div class="modal-footer">
				...
				<button type="submit" id="del_mes_button_manager" class="btn btn-primary2 btn-usr-act btn-usr-act marT10 marB5" data-action="act-pass">
					Eliminar
				</button>
			</div>
			</form>
