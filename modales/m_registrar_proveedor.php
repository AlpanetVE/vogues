...
<div class="modal fade bs-example-modal-lg modal-reg-prov" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			<form action="paginas/proveedor/fcn/f_proveedor.php" data-method="crearProveedor" id="reg-prov-form" class="reg-prov-form" method="post"  >			
						...
						<div class="row">
								...
								<div class="col-xs-5 ">
									<div class="text-right pad-right5">
										<span class="diff_titular">Usar un titular distinto</span><input type="checkbox" id="diff_titular" name="diff_titular" />
									</div>
								</div>
				...
				<button id="reg-prov-submit" type="button" class="btn btn-primary2">Next</button>
