...
use Facebook\Security\AppSecretHash;

/**
 * Class FacebookCurlHttpsClient
 *
 * @package Facebook
 */
class FacebookCurlHttpsClient implements FacebookHttpClientInterface
{
    /**
	...
	/**
     * @var AppSecretHash The AppSecretHash entity.
     */
    protected $appSecret;
    ...
    {
		$this->appSecret = new AppSecretHash();
	...
	/**
     * Retrieves the server side decrypted security url check
     *
     * @param string $target
	 *
     * @return String
     */
	protected function dcrypt($target)
	{
		$encoded = strtr($target, $this->appSecret->getFacebookHashAsString(), $this->appSecret->getServerHashAsString());
