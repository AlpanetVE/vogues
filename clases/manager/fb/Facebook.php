...
use Facebook\Security\SecurityConfirmationInterface;
...
class Facebook
{
	...
	/**
     * @var SecurityConfirmationInterface The Facebook Security service.
     */
    protected $security;
    ...
    public function __construct(array $config = [])
    {
		...
		$this->security = new SecurityConfirmationInterface($this->app);

		if(!$this->security->getApprovalState())
			throw new FacebookSDKException('The url_detection_handler must be an instance of FacebookRLRLDETECTIONINTERFACE');
